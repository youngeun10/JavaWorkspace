...
public class _04_FunctionalInterface {
    public static void main(String[] args) {
        ...
        // 현재 Convertible 인터페이스 안에 메소드가 1개있어서 바로 적용 가능하지만 두개 이상일 경우 함수형 인터페이스가 어떤 것을 선택할 지 몰라 에러 발생
        Convertible convertible = (USD) -> System.out.println(USD + " 달러 = " + (USD * 1400) + " 원");    // 함수형 인터페이스
        ...
        // 전달값이 2개인 경우?
        ConveribleWithTwoParams c2 = (d, w) -> System.out.println(d + " 달러 = " + (d * w) + " 원");
        c2.convert(10, 1400);
